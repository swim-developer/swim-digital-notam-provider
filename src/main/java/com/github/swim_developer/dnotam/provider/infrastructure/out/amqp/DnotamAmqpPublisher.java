package com.github.swim_developer.dnotam.provider.infrastructure.out.amqp;
...
@ApplicationScoped
public class DnotamAmqpPublisher extends AbstractAmqpPublisher implements AmqpPublisherHealthProvider {
    ...
    @Inject
    public DnotamAmqpPublisher(@Channel("dnotam-amqp-out") Emitter<String> amqpEmitter) {
