...
@Slf4j
@ApplicationScoped
public class DnotamHeartbeatPublisher implements SubscriptionHeartbeatPublisher {

    private final DnotamAmqpPublisher amqpPublisher;
    private final ObjectMapper objectMapper;

    @Inject
    public DnotamHeartbeatPublisher(DnotamAmqpPublisher amqpPublisher, ObjectMapper objectMapper) {
